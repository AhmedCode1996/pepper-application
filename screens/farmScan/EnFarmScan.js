import {
  ...
  const FarmScan = ({ navigation }) => {
    ...
    useEffect(() => {
      ...
      setTimeout(() => {
        if (
          ...
          navigation.navigate('EnScanResult');
          setLoading(false);
        }
      }, 4000);
    }, [image, output]);
    ...
    return (
      ...
      >
        <Text style={styles.textElement}>Crop Check</Text>
        <View style={styles.scanContent}>
          ...
          >
            ...
            />
            <Text style={styles.whiteText}>Take a Photo</Text>
          </Pressable>
          <Pressable
            onPress={
              isConnected
          ...
          >
            ...
            />
            <Text style={styles.whiteText}>From Gallery</Text>
          </Pressable>
        </View>
        {loading && (
          <View style={styles.loadingContainer}>
            <Lottie
              ...
              loop
            />
            <Text style={styles.scanText}>The image is being checked</Text>
          </View>
        )}
        {!isConnected && (
